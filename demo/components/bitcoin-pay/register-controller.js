...
function factory($scope, $location, brAlertService) {
  ...
  self.register = function() {
    ...
    navigator.payment.registerApp({
      ...
      name: 'BitcoinPay',
      //image: url + '/app.png',
      image: 'https://cdn.rawgit.com/google/material-design-icons/182053460b9e96cab11924c0b50dcb50dc8d5366/action/2x_web/ic_https_black_48dp.png',
      url: url,
...
return {bpRegisterController: factory};
